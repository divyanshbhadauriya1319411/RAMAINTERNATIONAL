      ...
      <div className="bg-[#020C1B] text-white py-12 border-b border-gold-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="space-y-1">
            <h1 className="font-serif text-2xl font-bold text-gold-500">Recruiter Command Desk</h1>
          ...
          <div className="bg-navy-900/60 border border-gold-500/10 rounded-xl p-3.5 flex items-center space-x-3 text-xs font-bold">
            <Landmark className="h-4.5 w-4.5 text-gold-500" />
            <div>
              <p className="text-gray-200">{profile?.companyName || "Almarai Foods"}</p>
            ...
            >
                ...
                <div className="space-y-6">
                  <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-[11px] text-gray-500 font-light font-sans">Monitor active hiring drives, screening pipelines and visa steps.</p>
                    </div>
                    <button
                      onClick={() => setShowJobForm(true)}
                      className="bg-navy-900 hover:bg-navy-800 text-gold-500 text-xs font-bold uppercase tracking-wider px-5 py-3 rounded-lg border border-gold-500/10 flex items-center space-x-1.5 shadow-sm cursor-pointer transition-colors"
                    >
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 text-xs font-semibold">
                    <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm space-y-1">
                      <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider block">Active campaigns</span>
                      <span className="text-2xl font-serif font-extrabold text-navy-900">{jobs.length}</span>
                    </div>
                    <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm space-y-1">
                      <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider block">Sourced Applicants</span>
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm space-y-1">
                      <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider block">Subscription Tier</span>
                      <span className="text-xs font-bold text-gold-600 uppercase tracking-widest block pt-2">Enterprise Core</span>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4 text-xs font-light">
                      {[
                        ...
                        <div key={i} className="flex space-x-3 items-start">
                          <span className="text-[10px] text-gold-600 font-bold shrink-0 w-20">{item.time}</span>
              ...
              {activeTab === "profile" && (
                <div className="bg-white border border-gray-200 rounded-xl p-6 sm:p-8 shadow-sm space-y-6">
                  ...
                  {profileMsg && (
                    <div className="p-4 bg-green-50 border border-green-200 text-green-700 rounded-lg text-xs font-semibold">
                      {profileMsg}
                    </div>
                  )}

                  <form onSubmit={handleUpdateProfile} className="space-y-4 text-xs font-semibold text-gray-500">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-luxury-light border border-gray-200 text-navy-900 rounded-lg p-3 outline-none focus:border-gold-500 font-medium"
                        />
                      </div>
                      <div>
                    ...
                    <button
                      ...
                      className="w-full bg-navy-900 hover:bg-navy-800 text-gold-500 font-bold uppercase tracking-wider py-3.5 rounded-lg border border-gold-500/10 flex items-center justify-center space-x-2 cursor-pointer disabled:opacity-50"
                    >
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm space-y-6">
                  ...
                  {jobs.length === 0 ? (
                    <div className="py-16 text-center text-gray-400 text-xs font-semibold">
                      <Briefcase className="h-8 w-8 text-gold-500 mx-auto mb-3" />
                        ...
                        <tbody className="divide-y divide-gray-100 font-medium">
                          {jobs.map((job) => (
                            <tr key={job.id} className="text-navy-900">
                              ...
                              <td className="py-4 text-gray-550">{job.sector}</td>
              ...
              {activeTab === "applicants" && (
                <div className="space-y-4">
                  <div className="pb-2 border-b border-gray-200">
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">Click candidate cards to update logs, schedule interviews, select or reject.</p>
                  </div>
              ...
              {activeTab === "reports" && (
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm space-y-6">
                  <div>
                    <h3 className="font-serif text-sm font-bold text-navy-900 pb-2 border-b border-gray-150 uppercase tracking-wider">Recruitment Analytics</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs text-gray-500 font-medium">
                    <div className="bg-luxury-light border border-gray-200 p-5 rounded-2xl space-y-4">
                      ...
                      <div className="space-y-3.5 font-semibold text-[11px]">
                        <div className="flex justify-between"><span>Applied CVs</span><span className="text-navy-900">100% (25)</span></div>
                        <div className="flex justify-between"><span>Shortlisted candidates</span><span className="text-navy-900">60% (15)</span></div>
                        <div className="flex justify-between"><span>Interviews Scheduled</span><span className="text-navy-900">40% (10)</span></div>
                        <div className="flex justify-between"><span>Consulate Selects</span><span className="text-navy-900">20% (5)</span></div>
                      </div>
                    </div>
                    ...
                    <div className="bg-luxury-light border border-gray-200 p-5 rounded-2xl space-y-4">
                      ...
                      <div className="space-y-3.5 font-semibold text-[11px]">
                        <div className="flex justify-between"><span>Time to select candidates</span><span className="text-navy-900">12 Days</span></div>
                        <div className="flex justify-between"><span>Medical & Wafid clearance</span><span className="text-navy-900">8 Days</span></div>
                        <div className="flex justify-between"><span>Consulate visa stamping</span><span className="text-navy-900">14 Days</span></div>
                        <div className="flex justify-between"><span>Average time to deploy</span><span className="text-navy-900">34 Days</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {activeTab === "billing" && (
                <div className="space-y-6">
                  {/* Subscription card */}
                  <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                    <div className="space-y-2">
                      <span className="text-[10px] text-gold-600 bg-gold-500/10 px-2 py-0.5 rounded uppercase font-bold tracking-wider">Active Tier</span>
                    ...
                    <div className="text-center md:text-right text-xs font-semibold">
                      ...
                      <p className="text-navy-900 text-lg font-bold">September 15, 2026</p>
                      <p className="text-gold-600 font-bold tracking-widest mt-1">₹1,50,000 / Annual</p>
                    </div>
                  </div>

                  {/* Invoices */}
                  <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm space-y-4">
                    <h3 className="font-serif font-bold text-xs text-navy-900 pb-3 border-b border-gray-150 uppercase tracking-wider">Invoice History</h3>
                    <div className="overflow-x-auto text-xs font-semibold">
                      <table className="w-full text-left border-collapse">
                        <thead>
                          <tr className="border-b border-gray-150 text-gray-400">
                        ...
                        <tbody className="divide-y divide-gray-100 font-medium">
                          {[
                            ...
                            <tr key={inv.id} className="text-navy-900">
                              <td className="py-4 font-bold">{inv.id}</td>
                              <td className="py-4 text-gray-500">{inv.period}</td>
                              <td className="py-4 text-gold-600 font-bold">{inv.amount}</td>
                              <td className="py-4">
                                <span className="bg-green-50 text-green-700 border border-green-200 px-2 py-0.5 rounded text-[10px] font-bold uppercase">
                                  {inv.status}
                                </span>
                              ...
                              <td className="py-4 text-right">
                                <button
                                  ...
                                  className="text-navy-900 hover:text-gold-600 font-bold uppercase tracking-wider inline-flex items-center space-x-1 cursor-pointer"
                                >
        ...
        {showJobForm && (
          ...
          >
            <motion.div
              ...
              className="bg-white border border-gray-200 rounded-xl max-w-2xl w-full text-navy-900 shadow-2xl p-6 sm:p-8 overflow-y-auto max-h-[90vh]"
            >
              <div className="flex justify-between items-start border-b border-gray-150 pb-4 mb-4">
                <div>
                  <h3 className="font-serif text-sm font-bold text-navy-900 uppercase tracking-wider">Publish Sourced Position</h3>
                  <p className="text-[10px] text-gray-500 font-light">Input technical qualifications to list on Job Board.</p>
                </div>
                <div className="flex items-center space-x-2 shrink-0">
                  <button
                    ...
                    className="bg-gold-500 hover:bg-gold-400 text-navy-955 px-3 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wider flex items-center space-x-1.5 disabled:opacity-50 cursor-pointer transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="text-gray-400 hover:text-navy-900 font-bold p-1.5 text-xs cursor-pointer border border-gray-200 rounded-lg"
                  >
                    ✕ Close
                  </button>
                </div>
              ...
              {formMsg && (
                <div className={`mb-6 p-4 rounded-lg border text-xs font-semibold ${formMsg.isError ? "bg-red-50 border-red-200 text-red-750" : "bg-green-50 border-green-200 text-green-705"}`}>
                  {formMsg.text}
                </div>
              )}

              <form onSubmit={handlePostJob} className="space-y-4 text-xs font-semibold text-gray-500 font-sans">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block mb-1 text-navy-900">Job Title *</label>
                    <input
                      type="text"
                      required
                      value={title}
                  ...
                  <div>
                    <label className="block mb-1 text-navy-900">Sourcing Sector *</label>
                    <select
                      value={sector}
                      onChange={(e) => setSector(e.target.value)}
                      className="w-full bg-luxury-light border border-gray-200 text-navy-900 rounded-lg p-3 outline-none focus:border-gold-500 font-medium cursor-pointer"
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    <label className="block mb-1 text-navy-900">Destination Country *</label>
                    <select
                      value={country}
                  ...
                  <div>
                    <label className="block mb-1 text-navy-900">Salary Range</label>
                    <input
                      type="text"
                      value={salaryRange}
                  ...
                  <div>
                    <label className="block mb-1 text-navy-900">Vacancies *</label>
                    <input
                      type="number"
                      required
                      value={vacancies}
                ...
                <div>
                  <label className="block mb-1 text-navy-900">Description *</label>
                  <textarea
                    rows={4}
                    required
                    value={description}
                    onChange={(e) => setDescription(e.target.value)}
                    className="w-full bg-luxury-light border border-gray-200 text-navy-900 rounded-lg p-3 outline-none focus:border-gold-500 font-medium resize-none"
                  />
                </div>

                <div>
                  <label className="block mb-1 text-navy-900">Requirements *</label>
                  <textarea
                    rows={3}
                    required
                    value={requirements}
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-gold-500 to-gold-600 text-navy-950 font-bold uppercase tracking-wider py-4 rounded-lg flex items-center justify-center space-x-2 text-xs shadow cursor-pointer disabled:opacity-50"
                >
