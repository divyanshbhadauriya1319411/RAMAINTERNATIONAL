    ...
    <>
      ...
      >
        <div className="max-w-[1440px] mx-auto px-8 w-full h-full flex items-center justify-between">
          ...
          {/* Tablet & Mobile Menu Triggers */}
          <div className="xl:hidden flex items-center space-x-3">
            
            {/* Tablet Only Controls: Visible only on tablet viewports (768px - 1279px) */}
            ...
            <button
              ...
              className={`p-2.5 cursor-pointer border rounded-lg transition-colors ${
                scrolled
        ...
        <AnimatePresence>
          {menuOpen && (
            <motion.div
              ...
              className={`xl:hidden mt-3 border-t max-h-[calc(100vh-80px)] overflow-y-auto scrollbar-hide text-xs font-bold uppercase tracking-wider ${
                scrolled
                  ? "bg-white border-navy-900/5 dark:bg-navy-950 dark:border-white/5"
            ...
            >
              <div className="p-4 space-y-2">
                ...
                <div className="pt-4 border-t border-navy-900/5 dark:border-white/5 flex items-center justify-between gap-4">
                  {/* Theme Toggle Button */}
                  <button
                    onClick={toggleTheme}
                    className={`flex items-center space-x-2 px-4 py-2.5 h-11 rounded-xl border text-[11px] font-extrabold uppercase tracking-wider transition-all duration-200 cursor-pointer ${
                      scrolled
                        ? "bg-navy-900/5 dark:bg-white/5 border-navy-900/10 dark:border-white/10 text-navy-900 dark:text-white"
                  ...
                  {/* Language Switcher */}
                  <LanguageSwitcher
                    className="rounded-full bg-navy-900/5 dark:bg-white/5 border border-navy-900/10 dark:border-white/10 p-0.5"
                    activeClass="bg-blue-600 text-white shadow-md"
                    inactiveClass={
                      scrolled
                        ? "text-navy-900 dark:text-gray-300 hover:bg-navy-900/5 dark:hover:bg-white/5"
                        : "text-white/85 dark:text-gray-300 hover:bg-white/10"
                    }
                    buttonClass="px-4 py-2.5 h-11 text-xs font-bold uppercase tracking-wider rounded-full flex items-center justify-center"
                  />
                </div>
